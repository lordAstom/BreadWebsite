...
class BreadOrderForm(FlaskForm):
    ...
    Onion_loaf = IntegerField(validators=[NumberRange(min=0, max=6, message="Invalid Number")], default=0)
    Potato_loaf = IntegerField(validators=[NumberRange(min=0, max=6, message="Invalid Number")], default=0)
    Olive_loaf = IntegerField(validators=[NumberRange(min=0, max=6, message="Invalid Number")], default=0)
    Pistacho_loaf = IntegerField(validators=[NumberRange(min=0, max=6, message="Invalid Number")], default=0)
    Wholemeal_Rye_loaf = IntegerField(validators=[NumberRange(min=0, max=6, message="Invalid Number")], default=0)
    ...
    Onion_stick = IntegerField(validators=[NumberRange(min=0, max=6, message="Invalid Number")], default=0)
    Potato_stick = IntegerField(validators=[NumberRange(min=0, max=6, message="Invalid Number")], default=0)
    Olive_stick = IntegerField(validators=[NumberRange(min=0, max=6, message="Invalid Number")], default=0)
    Pistacho_stick = IntegerField(validators=[NumberRange(min=0, max=6, message="Invalid Number")], default=0)
    Wholemeal_Rye_stick = IntegerField(validators=[NumberRange(min=0, max=6, message="Invalid Number")], default=0)
